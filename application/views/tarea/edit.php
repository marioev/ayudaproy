<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('tarea/edit/'.$tarea['tarea_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tarea_titulo" value="<?php echo ($this->input->post('tarea_titulo') ? $this->input->post('tarea_titulo') : $tarea['tarea_titulo']); ?>" class="form-control" id="tarea_titulo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tarea_archivo" class="control-label">Tarea Archivo</label>
						<div class="form-group">
							<input type="text" name="tarea_archivo" value="<?php echo ($this->input->post('tarea_archivo') ? $this->input->post('tarea_archivo') : $tarea['tarea_archivo']); ?>" class="form-control" id="tarea_archivo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tarea_fecha" class="control-label">Tarea Fecha</label>
						<div class="form-group">
							<input type="text" name="tarea_fecha" value="<?php echo ($this->input->post('tarea_fecha') ? $this->input->post('tarea_fecha') : $tarea['tarea_fecha']); ?>" class="has-datepicker form-control" id="tarea_fecha" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tarea_fechaentrega" value="<?php echo ($this->input->post('tarea_fechaentrega') ? $this->input->post('tarea_fechaentrega') : $tarea['tarea_fechaentrega']); ?>" class="form-control" id="tarea_fechaentrega" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tarea_fechahora" class="control-label">Tarea Fechahora</label>
						<div class="form-group">
							<input type="text" name="tarea_fechahora" value="<?php echo ($this->input->post('tarea_fechahora') ? $this->input->post('tarea_fechahora') : $tarea['tarea_fechahora']); ?>" class="has-datetimepicker form-control" id="tarea_fechahora" />
						</div>
					</div>
					<div class="col-md-6">
