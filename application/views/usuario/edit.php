			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="usuario_telefono" value="<?php echo ($this->input->post('usuario_telefono') ? $this->input->post('usuario_telefono') : $usuario['usuario_telefono']); ?>" class="form-control" id="usuario_telefono" />
						</div>
					</div>
					<div class="col-md-6">
